...
//     useEffect(() => {
//         fetch(`http://192.168.0.108:5002/user/user-role-single/${id}`)
...
//         fetch(`http://192.168.0.108:5002/user/user-role/edit/${userRoleId}`, {
//             method: 'PUT',
//             headers: {
...
//     useEffect(() => {
//         fetch('http://192.168.0.108:5002/user-role/btn')
//             .then(Response => Response.json())
